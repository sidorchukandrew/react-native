...
bool ReactNativeFeatureFlagsAccessor::defaultTextToOverflowHidden() {
  auto flagValue = defaultTextToOverflowHidden_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(3, "defaultTextToOverflowHidden");

    flagValue = currentProvider_->defaultTextToOverflowHidden();
    defaultTextToOverflowHidden_ = flagValue;
  }
...
bool ReactNativeFeatureFlagsAccessor::enableAndroidFontWeightAdjustment() {
  auto flagValue = enableAndroidFontWeightAdjustment_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(12, "enableAndroidFontWeightAdjustment");

    flagValue = currentProvider_->enableAndroidFontWeightAdjustment();
    enableAndroidFontWeightAdjustment_ = flagValue;
  }
...
bool ReactNativeFeatureFlagsAccessor::enableExclusivePropsUpdateAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(20, "enableExclusivePropsUpdateAndroid");
...
bool ReactNativeFeatureFlagsAccessor::enableFabricCommitBranching() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(21, "enableFabricCommitBranching");
...
bool ReactNativeFeatureFlagsAccessor::enableFabricLogs() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(22, "enableFabricLogs");
...
bool ReactNativeFeatureFlagsAccessor::enableFlexboxAutoMinSizeInStrictMode() {
  auto flagValue = enableFlexboxAutoMinSizeInStrictMode_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(23, "enableFlexboxAutoMinSizeInStrictMode");
...
bool ReactNativeFeatureFlagsAccessor::enableFontScaleChangesUpdatingLayout() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(24, "enableFontScaleChangesUpdatingLayout");
...
bool ReactNativeFeatureFlagsAccessor::enableIOSCompressedTextFrameAdjustment() {
  auto flagValue = enableIOSCompressedTextFrameAdjustment_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(25, "enableIOSCompressedTextFrameAdjustment");
...
bool ReactNativeFeatureFlagsAccessor::enableModuleArgumentNSNullConversionIOS() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(36, "enableModuleArgumentNSNullConversionIOS");
...
bool ReactNativeFeatureFlagsAccessor::enableMountingCoordinatorPullModelAndroid() {
  auto flagValue = enableMountingCoordinatorPullModelAndroid_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(37, "enableMountingCoordinatorPullModelAndroid");
...
bool ReactNativeFeatureFlagsAccessor::useNestedScrollViewAndroid() {
  auto flagValue = useNestedScrollViewAndroid_.load();
